...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.documentVersion.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.document-versions.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('version_number') ? 'is-invalid' : '' }}" type="number" name="version_number" id="version_number" value="{{ old('version_number', '') }}" step="1" required>
