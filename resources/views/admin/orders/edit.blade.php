    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.orders.update", [$order->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('date_created') ? 'is-invalid' : '' }}" type="text" name="date_created" id="date_created" value="{{ old('date_created', $order->date_created) }}" required>
